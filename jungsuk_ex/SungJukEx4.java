...
//			
//			if (student4.total == prevTotal) {
//				student4.schoolRank = prevRank ;
//				length -= 1 ;
//			} else {
//				student4.schoolRank = list.size() - length + 1 ;
//				length -= 1 ;  
//			}
//			prevRank =  student4.schoolRank;
//			prevTotal = student4.total;
//		}
		
		prevRank=0 ; 
		prevTotal=Integer.MAX_VALUE;
		int n=1;//동점자 수
		for(Student4 s:list){
